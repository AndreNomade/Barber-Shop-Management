...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        adicionarCliente->setObjectName(QStringLiteral("adicionarCliente"));
        QIcon icon;
        ...
        buscarCliente->setObjectName(QStringLiteral("buscarCliente"));
        buscarCliente->setIcon(icon);
        novoFuncionario = new QAction(MainWindow);
        novoFuncionario->setObjectName(QStringLiteral("novoFuncionario"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/img/icones/barbeiro.png"), QSize(), QIcon::Normal, QIcon::Off);
        novoFuncionario->setIcon(icon1);
        excluirFuncionario = new QAction(MainWindow);
        excluirFuncionario->setObjectName(QStringLiteral("excluirFuncionario"));
        excluirFuncionario->setIcon(icon1);
        adicionarServico = new QAction(MainWindow);
        adicionarServico->setObjectName(QStringLiteral("adicionarServico"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/img/icones/maquina.png"), QSize(), QIcon::Normal, QIcon::Off);
        adicionarServico->setIcon(icon2);
        listarServicos = new QAction(MainWindow);
        listarServicos->setObjectName(QStringLiteral("listarServicos"));
        listarServicos->setIcon(icon2);
        novoAcento = new QAction(MainWindow);
        novoAcento->setObjectName(QStringLiteral("novoAcento"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/img/icones/acento.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        menuFuncion_rios->setObjectName(QStringLiteral("menuFuncion_rios"));
        menuAcentos = new QMenu(menubar);
        menuAcentos->setObjectName(QStringLiteral("menuAcentos"));
        menuServi_os = new QMenu(menubar);
        menuServi_os->setObjectName(QStringLiteral("menuServi_os"));
